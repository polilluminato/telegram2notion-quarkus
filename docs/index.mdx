...
On the [examples](/pages/examples) page you can find examples of use of the bot.
...
more information can be found in the [Quarkus docs](/pages/quarkus-doc) section of the documentation.
